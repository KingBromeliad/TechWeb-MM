...
<body class="flex flex-row justify-end bg-fixed bg-cover bg-no-repeat h-screen w-screen" style="background-image: url(http://localhost:3000/Asset2.svg)">
  ...
  <img class="<div w-1/2 m-10 h-auto absolute bottom-0 left-0 mt-80" src="http://localhost:3000/Dino1.svg" >

  <div class="w-1/2 h-1/2 flex flex-col bg-white rounded-3xl m-10 z-10 text-black text-center text-6xl font-sans font-bold">
  <p class="m-auto">{{text}}</p>
  </div>

  <div class="absolute bottom-20 mr-20">
